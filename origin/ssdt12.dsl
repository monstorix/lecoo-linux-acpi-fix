...
DefinitionBlock ("", "SSDT", 2, "AMD", "UPEP", 0x00000001)
{
    ...
    External (_SB_.PCI0.SBRG.H_EC.PFSL, IntObj)
                ...
                ElseIf ((Arg0 == ToUUID ("11e00d56-ce64-47ce-837b-1f898f9aa461") /* Unknown UUID */))
                {
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (0x04)
                        {
                            M000 (0x3E04)
                            M460 ("    Return (0x00)\n", Zero, Zero, Zero, Zero, Zero, Zero)
                            M460 ("    uPEP Display On Notification \n", Zero, Zero, Zero, Zero, Zero, Zero)
                            Return (Zero)
                        }
                        Case (0x05)
                        {
                            M000 (0x3E05)
                            Debug = "*** uPEP Lowest Power State Entry ***"
                            M460 ("    uPEP Lowest Power State Entry \n", Zero, Zero, Zero, Zero, Zero, Zero)
                            M460 ("    Return (0x00)\n", Zero, Zero, Zero, Zero, Zero, Zero)
                            Return (Zero)
                        }
                        Case (0x06)
                        {
                            M000 (0x3E06)
                            Debug = "*** uPEP Lowest Power State Exit ***"
                            M460 ("    uPEP Lowest Power State Exit \n", Zero, Zero, Zero, Zero, Zero, Zero)
                            M460 ("    Return (0x00)\n", Zero, Zero, Zero, Zero, Zero, Zero)
                            Return (Zero)
                        }
                        Case (0x07)
                        {
                            M000 (0x3E07)
                            Debug = "*** uPEP Modern Standby Entry ***"
                            M460 ("    uPEP Modern Standby Entry \n", Zero, Zero, Zero, Zero, Zero, Zero)
                            M460 ("    Return (0x00)\n", Zero, Zero, Zero, Zero, Zero, Zero)
                            Return (Zero)
                        }
                        Case (0x08)
                        {
                            M000 (0x3E08)
                            Debug = "*** uPEP Modern Standby Exit ***"
                            M460 ("    uPEP Modern Standby Exit \n", Zero, Zero, Zero, Zero, Zero, Zero)

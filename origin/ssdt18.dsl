...
{
    External (_SB_.PCI0.SBRG.H_EC.ECMT, MutexObj)
    External (_SB_.PCI0.SBRG.H_EC.OKEC, IntObj)
    External (_SB_.PCI0.SBRG.H_EC.TSRC, FieldUnitObj)
    ...
    Scope (\_TZ)
    {
        ThermalZone (TZ01)
        {
            ...
            {
                Local0 = 0x0B74
                If (CondRefOf (\_SB.PCI0.SBRG.H_EC.OKEC))
                {
                    If ((\_SB.PCI0.SBRG.H_EC.OKEC == One))
                    {
                        If (CondRefOf (\_SB.PCI0.SBRG.H_EC.ECMT))
                        {
                            Acquire (\_SB.PCI0.SBRG.H_EC.ECMT, 0xFFFF)
                            If (CondRefOf (\_SB.PCI0.SBRG.H_EC.TSRC))
                            {
                                Local0 = \_SB.PCI0.SBRG.H_EC.TSRC /* External reference */
                                Local0 = (0x0AAC + (Local0 * 0x0A))
                            }

                            Release (\_SB.PCI0.SBRG.H_EC.ECMT)
                        }
                    }
                }

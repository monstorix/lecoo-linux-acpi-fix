        ...
        PowerResource (P0NV, 0x00, 0x0000)
        {
                ...
                If ((M4C0 != Zero))
                {
                    ...
                    ElseIf ((SI3R == One))
                    {
                        If ((NBRI != 0xFF))
                        {
                            ...
                            M460 ("PLA-ASL-\\_SB.PCI0.GPP8.P0NV._ON-UnLockNvme\n", Zero, Zero, Zero, Zero, Zero, Zero)
                            SMIC = 0xD8
                            SI3R = Zero
                        }
                    }
            ...
            Method (_OFF, 0, NotSerialized)  // _OFF: Power Off
            {
                ...
                If ((M4C0 != Zero))
                {
                    ...
                    ElseIf ((M049 (M4C0, 0x12) == One))
                    {
                        M460 ("PLA-ASL-\\_SB.PCI0.GPP8.P0NV._OFF-IsSetNvmePassword\n", Zero, Zero, Zero, Zero, Zero, Zero)
                        Local0 = M019 (Zero, One, 0x02, 0x18)
                        NBRI = ((Local0 & 0xFF00) >> 0x08)
                        M460 ("PLA-ASL-\\_SB.PCI0.GPP8.P0NV._OFF-NBRI:0x%X\n", NBRI, Zero, Zero, Zero, Zero, Zero)
                        If ((NBRI != 0xFF))
                        {
                            M460 ("PLA-ASL-\\_SB.PCI0.GPP8.P0NV._OFF-SavePCI\n", Zero, Zero, Zero, Zero, Zero, Zero)
